...
namespace SummerCampManagementSystem.BLL.Services
{
    public class GroupService : IGroupService
    {
        ...
        private void ValidateCampStatusForGroupOperation(Camp camp, string operation)
        {
            ...
            {
                throw new BadRequestException($"Không thể {operation} group khi trại đã ở trạng thái '{campStatus}'. Trại phải ở trạng thái Draft, PendingApproval, Published hoặc OpenForRegistration");
            }
        }
