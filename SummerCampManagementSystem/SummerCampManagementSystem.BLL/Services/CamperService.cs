...
namespace SummerCampManagementSystem.BLL.Services
{
    public class CamperService : ICamperService
    {
        ...
        public async Task<IEnumerable<CamperWithRegistrationStatus>> GetCampersByCampWithStatus(int campId)
        {
            ...
            // get campers from PendingAssignGroup onwards (PendingAssignGroup, Confirmed, Transporting, Transported, CheckedIn, CheckedOut)
            // exclude: PendingApproval, Approved, Rejected, Canceled
