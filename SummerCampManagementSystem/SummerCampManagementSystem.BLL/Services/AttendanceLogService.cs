...
namespace SummerCampManagementSystem.BLL.Services
{
    public class AttendanceLogService : IAttendanceLogService
    {
        ...
        public async Task<AttendanceLogResponseDto> CreateAttendanceLogAsync(AttendanceLogRequestDto attendanceLogDto)
        {
            ...
            bool isCamperInActivity = await _unitOfWork.AttendanceLogs.IsScheduleOfCamper(camper.groupId.Value, attendanceLogDto.ActivityScheduleId);
