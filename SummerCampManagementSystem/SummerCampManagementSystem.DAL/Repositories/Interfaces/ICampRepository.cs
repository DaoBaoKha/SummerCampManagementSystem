...
namespace SummerCampManagementSystem.DAL.Repositories.Interfaces
{
    public interface ICampRepository : IGenericRepository<Camp>
    {
        ...
        Task<List<(string TransactionCode, DateTime? TransactionDate, string PayerName, string Description, decimal Amount, string Status, string PaymentMethod, string Type)>> GetFinancialTransactionsAsync(int campId);
