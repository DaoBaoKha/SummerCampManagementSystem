...
namespace SummerCampManagementSystem.DAL.Repositories.Interfaces
{
    public interface IGroupRepository : IGenericRepository<Group>
    {
        ...
        Task<Group?> GetByIdWithCampAsync(int groupId);
        Task<Group?> GetByIdWithCamperGroupsAndCampAsync(int groupId);
        ...
        Task<List<int?>> GetGroupIdsWithSchedulesAsync(int campId);
        Task<IEnumerable<Group>> GetGroupsWithCampersByCampIdAsync(int campId);
        Task<IEnumerable<Group>> GetGroupsWithCampersByIdsAsync(List<int> groupIds);
    }
}
